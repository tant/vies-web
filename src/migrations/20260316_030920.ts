...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "site_settings_contact_phone" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "site_settings_contact_phone_locales" (
  	"label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'VIES' NOT NULL,
  	"logo_id" integer,
  	"favicon_id" integer,
  ...
  CREATE TABLE "footer_locales" (
  	"copyright" varchar DEFAULT '© 2026 VIES. All rights reserved.',
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  ALTER TABLE "site_settings_contact_phone" ADD CONSTRAINT "site_settings_contact_phone_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_settings"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "site_settings_contact_phone_locales" ADD CONSTRAINT "site_settings_contact_phone_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_settings_contact_phone"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "site_settings_contact_phone_order_idx" ON "site_settings_contact_phone" USING btree ("_order");
  CREATE INDEX "site_settings_contact_phone_parent_id_idx" ON "site_settings_contact_phone" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "site_settings_contact_phone_locales_locale_parent_id_unique" ON "site_settings_contact_phone_locales" USING btree ("_locale","_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "site_settings_contact_phone" CASCADE;
  DROP TABLE "site_settings_contact_phone_locales" CASCADE;
